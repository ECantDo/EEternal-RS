/// Yoinked the magic numbers from Reckless (thanks!)
/// I don't see the need to generate my own magic numbers when this is available... That and
/// also in the new flat array LUT architecture vs my dumber [64][4096] 2D array from C++.
